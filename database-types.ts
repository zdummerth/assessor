...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      deed_abstracts_history: {
        Row: {
          change_type: string
          changed_at: string
          changed_by_employee_user_id: string
          deed_abstract_id: number
          id: number
          new_data: Json | null
          old_data: Json | null
        }
        ...
        Relationships: [
          {
            foreignKeyName: "deed_abstracts_history_changed_by_employee_user_id_fkey"
            columns: ["changed_by_employee_user_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["user_id"]
          },
          {
            foreignKeyName: "deed_abstracts_history_deed_abstract_id_fkey"
            columns: ["deed_abstract_id"]
            isOneToOne: false
            referencedRelation: "deed_abstracts"
            referencedColumns: ["id"]
          },
        ]
      }
