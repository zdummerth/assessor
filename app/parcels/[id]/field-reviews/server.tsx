            ...
            <div className="grid gap-2 grid-cols-2 sm:grid-cols-3 md:grid-cols-4">
              {latest.field_review_images!.map((img) => {
                ...
                return (
                  <div
                    key={img.id}
                    className="rounded border overflow-hidden bg-gray-500"
                  >
                    <Image
                      src={src}
                      alt={
              ...
              return (
                <li key={r.id} className="px-3 py-3 flex items-center gap-3">
                  ...
                  <ReviewThreadModal
                    ...
                    trigger={
                      <button className="inline-flex items-center gap-1 text-xs px-2 py-1 rounded border hover:bg-gray-500 shrink-0">
                        <PlusCircle className="w-4 h-4" />
                        Open
                      </button>
                    }
