  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onClose={setIsOpen} className="relative z-50">
        <DialogBackdrop className="fixed inset-0 bg-zinc-700/70 backdrop-blur-sm" />

        <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
          <DialogPanel className="w-full max-h-[95vh] overflow-y-auto max-w-4xl space-y-4 bg-background border p-2 md:p-8 rounded shadow">
            ...
            <div className="space-y-3 text-sm">
              <form action={addStatusAction} className="flex items-end gap-2">
                ...
                <button
                  type="submit"
                  className="bg-blue-600 text-white p-2 h-10 rounded"
              ...
              {notes.length === 0 ? (
                ...
                <div className="space-y-2">
                  {notes.map((n) => {
                    ...
                    return (
                      <div key={n.id} className="rounded border shadow-sm p-3">
