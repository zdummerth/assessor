...
export default function PrintableInvoice({
  ...
  return (
    <div className="w-full flex flex-col border rounded-md mx-auto p-8 w-[8.5in] h-[11in] print:p-0 print:border-none">
      ...
      <div className="mt-4 border-t-2 border-black pt-4 mt-auto mb-4 w-48">
        <p>Shawn T. Ordway</p>
